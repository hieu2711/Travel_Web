...
@NamedQueries({
    ...
    @NamedQuery(name = "Rating.findById", query = "SELECT c FROM Rating c WHERE c.id = :id"),
    @NamedQuery(name = "Rating.findByRating", query = "SELECT c FROM Rating c WHERE c.rating = :rating")})
public class Rating implements Serializable {
    ...
    public String toString() {
        return "com.tdh.pojo.Rating[ id=" + id + " ]";
    }
}
